...
class Components {
    ...
    renderReportFall(singleReport, reportTYpeQuesiontsUL) {
    ...
    renderReportGunShotWound(singleReport, reportTYpeQuesiontsUL) {
    ...
    renderReportMotorVehicleCrash(singleReport, reportTYpeQuesiontsUL) {
    ...
    renderReportOther(singleReport, reportTYpeQuesiontsUL) {
    ...
    renderReportSingle(endpoint, id) {
        ...
        Api().getRequest(
            ...
            singleReport => {
                ...
                this.reportTypeCheck(endpoint, singleReport, reportTYpeQuesiontsUL);
    ...
    reportTypeCheck(endpoint, singleReport, reportTYpeQuesiontsUL) {
        if (endpoint == "other-reports") {
            this.renderReportOther(singleReport, reportTYpeQuesiontsUL);
        }
        if (endpoint == "motor-vehicle-crash-reports") {
            this.renderReportMotorVehicleCrash(singleReport, reportTYpeQuesiontsUL);
        }
        if (endpoint == "gun-shot-wound-reports") {
            this.renderReportGunShotWound(singleReport, reportTYpeQuesiontsUL);
        }
        if (endpoint == "fall-reports") {
            this.renderReportFall(singleReport, reportTYpeQuesiontsUL);
        }
    }
